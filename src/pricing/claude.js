...
const CLAUDE_PRICING = {
  ...
  "claude-opus-4-1-20250414": { input: 15, output: 75, cacheRead: 1.5, cacheWrite: 18.75 },
  ...
  "claude-haiku-3-5-20241022": { input: 0.8, output: 4, cacheRead: 0.08, cacheWrite: 1.0 },
};
...
export function getClaudePricing(modelId) {
  ...
  if (id.includes("opus")) return { input: 15, output: 75, cacheRead: 1.5, cacheWrite: 18.75 };
  if (id.includes("sonnet")) return { input: 3, output: 15, cacheRead: 0.3, cacheWrite: 3.75 };
  if (id.includes("haiku") && id.includes("3")) return { input: 0.8, output: 4, cacheRead: 0.08, cacheWrite: 1.0 };
