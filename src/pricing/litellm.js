...
function toMTok(entry) {
  ...
  return {
    ...
    inputPriority: opt("input_cost_per_token_priority"),
    outputPriority: opt("output_cost_per_token_priority"),
    cacheReadPriority: opt("cache_read_input_token_cost_priority"),
